...
This is a fork from [react-toolbox](https://github.com/react-toolbox/react-toolbox) to allow the use of some unpublished fixes. It also fixes an issue with dropdown outline being shown after selecting an item.
